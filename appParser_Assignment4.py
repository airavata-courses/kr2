...
queueValidation=getDelta(timestamp_batch_queue,timestamp_api_server_launched)
expStatusValidation=getDelta(timestamp_status_queue,timestamp_batch_queue)
orchestratorLaunch=getDelta(timestamp_orchestrator_launch_end,timestamp_status_queue)
